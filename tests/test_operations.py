"""Unit tests for arithmetic and math operations with experimental values"""
...
class TestArithmetic:
    ...
    def reset_environment(self):
        """Rests all default configurations"""
    ...
    def test_elementary_operations(self):
        """Test elementary arithmetic operations"""
    ...
    def test_measurement_arrays(self):
        """Test arithmetic with measurement arrays"""
...
class TestMathFunctions:
    """Tests wrappers around math functions"""
    ...
    def test_simple_functions(self):
        ...
        assert isinstance(res_sqrt_const, float)
        ...
        assert isinstance(res_exp_const, float)
    ...
    def test_more_advanced_functions(self):
        """Test log functions and power functions"""
    ...
    def test_measurement_arrays(self):
        """Test math operations with measurement arrays"""
        ...
        assert isinstance(res, q.data.datasets.ExperimentalValueArray)
        assert res[2].value == pytest.approx(0.6826061944859854)
        assert res[2].error == pytest.approx(0.10355582242660198)
